...
class ImportWaveform(CollectionNode):
    ...
    def execute(self, prevNodeOutput={}):
        ...
        dbData = []
        for curFile in self.property['inputFiles']:
        ...
        query =  ("INSERT INTO %s "
                  "(file_type, wf_id, filename, orig_path, network, recorder_serial, channel, location, sps, numsamp, begin_date, begin_time, station_id, unit_id, sensor_id) "
    ...
    def getDbData(self, filename, format, Trace):
        ...
        if wfDirId:
            ...
            relativeFilename = filename.replace('/home/stefan/Projects/science/raw/demoDataSets/limbergSteinbruch/convertedRaw', '')
