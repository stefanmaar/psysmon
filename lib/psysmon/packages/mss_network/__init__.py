...
name = "mss_network"                                 # The package name.
...
description = "psysmon nodes used within the MSS Network project."            # The package description.
...
collection_node_modules = ['quarry_blast_classification',
                           ...
                           'publish_report',
                           'lc_mss_compute_quarry_blast_report',
                           'lc_mss_visualize_quarry_blast_report']
