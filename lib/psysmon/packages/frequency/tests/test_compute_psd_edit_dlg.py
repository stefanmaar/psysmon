...
class ComputePsdEditDlgTestCase(unittest.TestCase):
    """
    """
    @classmethod
    def setUpClass(cls):
    ...
    def setUp(self):
        ...
        nodeTemplate = self.psybase.packageMgr.getCollectionNodeTemplate('compute PSD')
...
def suite():
    return unittest.makeSuite(ComputePsdEditDlgTestCase, 'test')
