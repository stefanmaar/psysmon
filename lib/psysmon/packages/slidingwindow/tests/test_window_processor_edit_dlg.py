...
class EventProcessorEditDlgTestCase(unittest.TestCase):
    """
    """
    @classmethod
    def setUpClass(cls):
    ...
    def setUp(self):
        ...
        nodeTemplate = self.psybase.packageMgr.getCollectionNodeTemplate('sliding window processor')
...
def suite():
    return unittest.makeSuite(EventProcessorEditDlgTestCase, 'test')
