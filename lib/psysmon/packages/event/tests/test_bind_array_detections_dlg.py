...
class BindArrayDetectionsDlgTestCase(unittest.TestCase):
    """
    """
    @classmethod
    def setUpClass(cls):
    ...
    def setUp(self):
        ...
        nodeTemplate = self.psybase.packageMgr.getCollectionNodeTemplate('bind array detections')
...
def suite():
    return unittest.makeSuite(BindArrayDetectionsDlgTestCase, 'test')
