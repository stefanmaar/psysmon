...
class ImportBulletinEditDlgTestCase(unittest.TestCase):
    """
    ...
    def setUp(self):
        ...
        nodeTemplate = self.psybase.packageMgr.getCollectionNodeTemplate('import earthquake bulletin')
...
def suite():
    return unittest.makeSuite(ImportBulletinEditDlgTestCase, 'test')
