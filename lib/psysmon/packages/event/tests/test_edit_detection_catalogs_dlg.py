...
class EditDetectionCatalogsDlgTestCase(unittest.TestCase):
    """
    """
    @classmethod
    def setUpClass(cls):
    ...
    def setUp(self):
        ...
        nodeTemplate = self.psybase.packageMgr.getCollectionNodeTemplate('edit detection catalogs')
...
def suite():
    return unittest.makeSuite(EditDetectionCatalogsDlgTestCase, 'test')
