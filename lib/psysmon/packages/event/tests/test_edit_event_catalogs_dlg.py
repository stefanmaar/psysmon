...
class EditEventCatalogsDlgTestCase(unittest.TestCase):
    """
    """
    @classmethod
    def setUpClass(cls):
    ...
    def setUp(self):
        ...
        nodeTemplate = self.psybase.packageMgr.getCollectionNodeTemplate('edit event catalogs')
...
def suite():
    return unittest.makeSuite(EditEventCatalogsDlgTestCase, 'test')
