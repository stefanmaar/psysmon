...
class EditDetectionCatalogs(CollectionNode):
    ''' Collection node to edit detection catalogs.
    '''

    name = 'edit detection catalogs'
    mode = 'execute only'
    category = 'Event'
    tags = ['stable',]
...
class EditDetectionCatalogsDlg(wx.Frame):

    def __init__(self, collection_node, project, parent = None, id = wx.ID_ANY, title='edit detection catalogs',
                 size=(640,480)):
    ...
    def init_ui(self):
        ...
        self.list_ctrl = CatalogListCtrl(parent = self,
                                         id = wx.ID_ANY,
                                         style=wx.LC_REPORT
                                         | wx.BORDER_NONE
                                         | wx.LC_SINGLE_SEL
        ...
        self.list_ctrl.SetMinSize(self.list_ctrl.GetBestSize())
    ...
    def update_list_ctrl(self):
        ...
        self.list_ctrl.SetColumnWidth(3, wx.LIST_AUTOSIZE)
        self.list_ctrl.SetColumnWidth(4, wx.LIST_AUTOSIZE)
        self.list_ctrl.SetColumnWidth(5, wx.LIST_AUTOSIZE)
        self.list_ctrl.resizeColumn(-1)
...
class CatalogListCtrl(wx.ListCtrl, listmix.ListCtrlAutoWidthMixin):
...
class EditDlg(wx.Dialog):
    ...
    def __init__(self, dialog_fields, data = None, parent=None, size=(300, 200)):
        wx.Dialog.__init__(self, parent, wx.ID_ANY, "Create a new detection catalog.", size=size)
