...
class ExportEventPicks(package_nodes.CollectionNode):
    ''' Export the picks of events to a data file.
    '''
    name = 'export event picks'
    mode = 'editable'
    category = 'Event'
    tags = ['export', 'event', 'pick', 'csv']
    ...
    def edit(self):
        ...
        # Initialize the pick catalog name preference item.
        pick_catalog_names = self.pick_library.get_catalogs_in_db(project = self.project)
        self.pref_manager.set_limit('pick_catalog_name', pick_catalog_names)
    ...
    def execute(self, prevNodeOutput={}):
        ...
        exporter = EventPickExporter(project = self.project,
        ...
        exporter.export(start_time = start_time,
                        ...
                        event_tags = event_tags,
                        pick_catalog_name = self.pref_manager.get_value('pick_catalog_name'))
...
class EventPickExporter(object):
